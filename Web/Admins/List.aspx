<%@ Page Title="Admins" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="EateryManager.Web.Admins.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="UserPwd" HeaderText="用户密码" SortExpression="UserPwd" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="TrueName" HeaderText="真实姓名" SortExpression="TrueName" ItemStyle-HorizontalAlign="Center"  /> 
